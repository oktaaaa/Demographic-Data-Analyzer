...
def calculate_demographic_data(print_data=True):
    ...
    average_age_men = round(male_age.mean(),1)
    ...
    percentage_country = round(country_50k/population*100,1)

    highest_earning_country = percentage_country.sort_values(ascending=False).idxmax()
    highest_earning_country_percentage = percentage_country.sort_values(ascending=False).max()
